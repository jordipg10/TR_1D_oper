        ...
        !> Time loop
            ...
            !> Target waters loop
                do j=1,target_waters_new(this%num_ext_waters+1)%solid_chemistry%reactive_zone%speciation_alg%num_aq_prim_species
                    conc_comp(j,1)=anal_sol_comp(conc_comp_init(j,1),1d0,spatial_discr_tpt%get_mesh_size(),&
                    spatial_discr_tpt%init_point,spatial_discr_tpt%get_mesh_size()*10,time,phi,D,q)
                end do
                ...
                do j=1,target_waters_new(this%num_target_waters)%solid_chemistry%reactive_zone%speciation_alg%num_aq_prim_species
                    conc_comp(j,2)=anal_sol_comp(conc_comp_init(j,2),1d0,spatial_discr_tpt%get_mesh_size(),&
                    spatial_discr_tpt%init_point+spatial_discr_tpt%measure,spatial_discr_tpt%get_mesh_size()*10,time,phi,D,q)
                end do

...
subroutine check_new_reactive_zones(this,i,tolerance)
    ...
    integer(kind=4) :: j,k,l,p,r,s,m,ii,kk,ll,old_num_react_zones,num_new_react_zones,num_sol_conc_zero,num_nf_sp_new,num_tar_sol,num_rep_rows
    integer(kind=4), allocatable :: tar_sol_indices(:),old_conc_zero_flag(:,:),new_conc_zero_flag(:,:),ind_sol_conc_zero(:),ind_conc_zero(:,:),ind_rep_rows(:)

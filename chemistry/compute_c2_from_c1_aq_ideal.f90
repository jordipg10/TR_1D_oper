...
subroutine compute_c2_from_c1_aq_ideal(this,c2)
    ...
    log_c2=matmul(this%solid_chemistry%reactive_zone%speciation_alg%Se_1_star,log10(this%concentrations(1:n_p)))+this%solid_chemistry%reactive_zone%speciation_alg%logK_tilde !> mass action law
    c2=10**log_c2

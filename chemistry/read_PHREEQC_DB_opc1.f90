...
subroutine read_PHREEQC_DB_opc1(this,unit,filename)
    ...
    integer(kind=4) :: irec,eq_ind,valence,num_mas_sp,num_prim_mas_sp,num_sec_mas_sp,i,j,k,l,num_surf_compl,num_exch_sp,num_mins,num_mins_eq,num_nf_sp,sp_ind,end_of_file, nbwtype, nrwtype,min_ind,eq_react_ind,num_gas,num_eq_ph,chem_syst_type,n_eq,n_k,num_react_zones,aq_sp_ind,elem_name_len,niter,num_elem
    ...
    character(len=256) :: label,str,str_block,str3,str4,gfw_form,path_name,Monod_name,file_kin_params,chem_syst_file,sol_str,eq_phase_str

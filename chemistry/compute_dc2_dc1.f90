...
!> Variables
    ...
    !allocate(d_log_gamma_d_log_c(this%solid_chemistry%reactive_zone%speciation_alg%num_species,this%solid_chemistry%reactive_zone%speciation_alg%num_species))
...
!> We compute linear system with logarithms
    allocate(log_dc2_dc1(this%solid_chemistry%reactive_zone%speciation_alg%num_eq_reactions,this%solid_chemistry%reactive_zone%speciation_alg%num_prim_species))
    aux_mat=5d-1*log(1d1)*(matmul(this%solid_chemistry%reactive_zone%speciation_alg%Se_1_star,out_prod(1:this%solid_chemistry%reactive_zone%speciation_alg%num_prim_species,this%solid_chemistry%reactive_zone%speciation_alg%num_prim_species+1:this%solid_chemistry%reactive_zone%speciation_alg%num_species))-out_prod(this%solid_chemistry%reactive_zone%speciation_alg%num_prim_species+1:this%solid_chemistry%reactive_zone%speciation_alg%num_species,this%solid_chemistry%reactive_zone%speciation_alg%num_prim_species+1:this%solid_chemistry%reactive_zone%speciation_alg%num_species))
    ...
    indep_mat=matmul(this%solid_chemistry%reactive_zone%speciation_alg%Se_1_star,aux_mat)-5d-1*log(1d1)*diag_c1%prod_mat_diag_mat(out_prod(this%solid_chemistry%reactive_zone%speciation_alg%num_prim_species+1:this%solid_chemistry%reactive_zone%speciation_alg%num_species,1:this%solid_chemistry%reactive_zone%speciation_alg%num_prim_species))

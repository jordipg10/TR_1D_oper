...
!> Pre-Process
    ...
    allocate(residual(n_p),dc2nc_dc1(n_e,n_p),Delta_c1(n_p),d_log_gamma_d_I(n_nc),out_prod_aq(n_nc_aq,n_nc_aq),log_Jacobian_act_coeffs_aq(n_nc_aq,n_nc_aq),log_Jacobian_act_coeffs(n_nc,n_nc))
    niter=0

...
!> Pre-process
    ...
    !> We apply mass action law to compute concentration secondary variable activity species
        log_c2nc_new=matmul(this%speciation_alg%Se_nc_1_star,log_gamma1_old+log10(this%concentrations(1:n_p)))+this%speciation_alg%logK_star-log_gamma2nc_old !> mass action law

...
!> Newton-Raphson
    ...
    !> We check dc2_dc1
        ...
        call this%compute_res_Jac_res_anal(indices_icon,n_icon,indices_constrains,ctot,dc2_dc1(1:this%solid_chemistry%reactive_zone%speciation_alg%num_sec_aq_species,:),log_Jacobian_act_coeffs,res,Jac_res)

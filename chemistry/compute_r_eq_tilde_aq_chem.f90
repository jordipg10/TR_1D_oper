...
!    c2nc=this%concentrations(this%speciation_alg%num_aq_prim_species+1:this%speciation_alg%num_aq_var_act_species)
...
!    allocate(R_eq(this%speciation_alg%num_eq_reactions)) !> R_eq=Delta_t*r_eq*Lambda^T_j/phi

...
!> Activities
    do i=1,n_icon(3)
        ...
        do j=1,this%speciation_alg%num_aq_prim_species
            Jac_res(indices_icon%cols(3)%col_1(i),j)=(10**(this%log_act_coeffs(indices_icon%cols(3)%col_1(i))))*(log_Jacobian_act_coeffs(indices_icon%cols(3)%col_1(i),j)+dot_product(log_Jacobian_act_coeffs(indices_icon%cols(3)%col_1(i),this%speciation_alg%num_prim_species+1:this%speciation_alg%num_species),dc2_dc1(:,j)))*(conc(indices_icon%cols(3)%col_1(i))/conc(j))
        end do
...
!> Phases
    do i=1,n_icon(4)
        ...
        res(indices_icon%cols(4)%col_1(i))=dot_product(this%chem_syst%Se(indices_constrains(ind_cstr),1:this%speciation_alg%num_prim_species),log10(this%activities(1:this%speciation_alg%num_aq_prim_species)))+log10(ctot(indices_icon%cols(4)%col_1(i)))-log10(this%chem_syst%eq_reacts(indices_constrains(ind_cstr))%eq_cst)
        do j=1,this%speciation_alg%num_aq_prim_species
            Jac_res(indices_icon%cols(4)%col_1(i),j)=dot_product(this%chem_syst%Se(indices_constrains(ind_cstr),1:this%speciation_alg%num_aq_prim_species),log_Jacobian_act_coeffs(1:this%speciation_alg%num_aq_prim_species,j)+matmul(log_Jacobian_act_coeffs(1:this%speciation_alg%num_aq_prim_species,this%speciation_alg%num_prim_species+1:this%speciation_alg%num_species),dc2_dc1(:,j)))
...
!> Cation exchange capacity
    res(this%speciation_alg%num_prim_species)=dot_product(this%speciation_alg%comp_mat_cst_act(this%speciation_alg%num_prim_species,:),conc)-CEC
    do j=1,this%speciation_alg%num_aq_prim_species
        Jac_res(this%speciation_alg%num_prim_species,j)=this%speciation_alg%comp_mat_cst_act(this%speciation_alg%num_prim_species,j)+dot_product(this%speciation_alg%comp_mat_cst_act(this%speciation_alg%num_prim_species,this%speciation_alg%num_prim_species+1:this%speciation_alg%num_species),dc2_dc1(:,j))
    end do
end subroutine
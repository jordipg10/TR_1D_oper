...
!>    do
!>        read(unit,*,iostat=int_var) aq_species%name, aq_species%params_act_coeff%ion_size_param, aq_species%valence, aq_species%molecular_weight
!>        !if (int_var<0) then
!>        !>    exit
...
!>        do
!>            !read(unit,*,iostat=int_var) aq_species%name, num_reactants, ((this%eq_reacts(ind_eq_reacts)%stoichiometry(j), this%eq_reacts(ind_eq_reacts)%species(j)%name), j=1,num_reactants), log_K, aq_species%ionic_radius, aq_species%valence!, aq_species%params_act_coeff%b_TJ, aq_species%molecular_weight
!>            !read(unit,*,iostat=int_var) aq_species%name, num_reactants, (eq_react%stoichiometry(j), eq_react%species(j), j=1,num_reactants), log_K, aq_species%ionic_radius, aq_species%valence!, aq_species%params_act_coeff%b_TJ, aq_species%molecular_weight
...
!>            if (aq_sp_flag==.true.) then
!>                ind_aq_compl=ind_aq_compl+1
!>                read(unit,*,iostat=int_var) aq_species%name, num_reactants, ((this%eq_reacts(ind_eq_reacts)%stoichiometry(j), this%eq_reacts(ind_eq_reacts)%species(j)%name), j=1,num_reactants), log_K, aq_species%params_act_coeff%ion_size_param, aq_species%valence, aq_species%molecular_weight

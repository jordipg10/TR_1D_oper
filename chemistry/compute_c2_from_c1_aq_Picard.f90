...
!> Process
    do
        ...
        log_c2_new=matmul(this%solid_chemistry%reactive_zone%speciation_alg%Se_1_star,log_gamma1_old+log10(THIS%concentrations(1:n_p)))+this%solid_chemistry%reactive_zone%speciation_alg%logK_tilde-log_gamma2_old !> mass action law

module m_surface_constcap
!-------------------------------------------------------------------------
!
!   $Description: Represent one surface with constant capacitance model
!
!   $Use:
!
...
!%------------------------------------------------------------
!%------------------------------------------------------------
type, public::t_surface_constcap
...
end type t_surface_constcap
 
!%----------------------------------------------------
!%----------------------------------------------------
interface create_
 
module procedure create_surfconstcap
...
module procedure destroy_surfconstcap
...
module procedure set_surface_constcap
...
module procedure set_parent_surface_constcap
...
module procedure compute_txoh_surfconstcap
...
module procedure compute_dtxoh_surfconstcap
...
module procedure compute_sigma0_surfconstcap1
module procedure compute_sigma0_surfconstcap2
...
module procedure compute_dsigma0_surfconstcap1
module procedure compute_dsigma0_surfconstcap2
...
module procedure init_surfconstcap
...
module procedure update_sk_surfconstcap
...
module procedure get_num_sk_surfconstcap
...
module procedure write_surfconstcap
...
module procedure get_num_xoh_surfconstcap
...
module procedure get_xoh_index_surfconstcap
...
module procedure get_name_xoh_surfconstcap
...
module procedure update_temp_param_surfconstcap
module procedure update_xoh_in_cd_surfconstcap
...
module procedure copy_surfconstcap
...
!%************************************************************
!%************************************************************
subroutine create_surfconstcap &
   (this)
implicit none
!-------------------------------------------------------------------------
!
...
type(t_surface_constcap), intent(inout) :: this 
!-------------------------------------------------------------------------
!
!   $Pre-cond:
!
...
!%************************************************************
!%************************************************************
subroutine destroy_surfconstcap &
   (this)
implicit none
!-------------------------------------------------------------------------
!
...
!%************************************************************
!%************************************************************
subroutine update_temp_param_surfconstcap &
   (this, &
    temp, &
    iserror)
implicit none
...
!%************************************************************
!%************************************************************
subroutine update_xoh_in_cd_surfconstcap &
   (this, &
    cd, &
    sk)
implicit none
...
type(t_surface_constcap), intent(in)   :: this
...
!%************************************************************
!%************************************************************
subroutine get_num_sk_surfconstcap &
   (this, &
    numskloc)
implicit none
!-------------------------------------------------------------------------
...
!%************************************************************
!%************************************************************
subroutine get_num_xoh_surfconstcap &
   (this, &
    numxoh)
implicit none
!-------------------------------------------------------------------------
...
!%************************************************************
!%************************************************************
subroutine get_name_xoh_surfconstcap &
   (this, &
    namexoh, &
    numxoh)
implicit none
...
!%************************************************************
!%************************************************************
subroutine set_surface_constcap &
   (this, &
    parent, &
    iserror)
...
!%************************************************************
!%************************************************************
subroutine set_parent_surface_constcap &
   (this, &
    parent)
...
!%************************************************************
!%************************************************************
subroutine get_xoh_index_surfconstcap &
   (this, &
    idxoh, &
    numxoh)
implicit none
...
if (value<=r0) then
 msg='Error, specific surface area must be > 0'
 goto 10 
end if
value=minval(capint)
if (value<=r0) then
 msg='Error, internal capacitance must be > 0'
 goto 10 
end if
!%------------------------------------------------------------
!%------------------------------------------------------------
...
do i=1,this%pp%numsite
 ...
 sk(isk+2)=dexp(-this%cte_f_rt*sigma0(i)/capint(i))
 isk=isk+numsk
end do
!%------------------------------------------------------------
...
write (ioutput,*) '           Model: Constant Capacitance        '
!%-----------------------------------------------------------
...
!%************************************************************
!%************************************************************
subroutine update_sk_surfconstcap &
   (this, &
    sk, &
    cd, &
    dcd, &
...
call compute_sigma0_(this,sigma2,expfi0,capint,this%pp%numsite)
call compute_dsigma0_(this,dsigma2,expfi0,capint,this%pp%numsite)
isk=0
do i=1,this%pp%numsite
...
!%************************************************************
!%*************************************************************
subroutine compute_dsigma0_surfconstcap2 &
   (this, &
    dsigma0, &
    expfi0, &
    capint, &
...
ipri=0
do i=1,this%pp%numsite
 dsigma0(i,ipri+2)=cte*capint(i)/expfi0(i)
 ipri=ipri+numsk
end do
!%-----------------------------------------------------------
return
...
!%************************************************************
!%************************************************************
subroutine compute_sigma0_surfconstcap2 &
   (this, &
    sigma0, &
    expfi0, &
    capint, &
...
!%************************************************************
!%************************************************************
subroutine compute_sigma0_surfconstcap1 &
   (this, &
    sigma0, &
    cd, &
    spsurfarea, &
...
!%************************************************************
!%************************************************************
subroutine compute_dsigma0_surfconstcap1 &
   (this, &
    dsigma0, &
    cd, &
    dcd, &
...
!%************************************************************
!%************************************************************
subroutine compute_txoh_surfconstcap &
   (this, &
    txohc, &
    cd, &
    numsite)
...
!%************************************************************
!%************************************************************
subroutine compute_dtxoh_surfconstcap &
   (this, &
    dtxoh, &
    sk, &
    cd, &
...
type(t_surface_constcap), intent(out) :: copied 

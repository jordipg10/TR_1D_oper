        !COMPILER-GENERATED INTERFACE MODULE: Fri Nov 15 22:51:50 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE TRANSPORT_ITER_SPECIES_AQ_CHEM__genmod
          INTERFACE 
            SUBROUTINE TRANSPORT_ITER_SPECIES_AQ_CHEM(THIS,C1_OLD,      &
     &C2NC_IG,C_TILDE,CONC_NC,CONC_COMP,POROSITY,DELTA_T)
            ...
            END SUBROUTINE TRANSPORT_ITER_SPECIES_AQ_CHEM
          END INTERFACE 
        END MODULE TRANSPORT_ITER_SPECIES_AQ_CHEM__genmod

        !COMPILER-GENERATED INTERFACE MODULE: Mon Nov 25 12:22:54 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE TRANSPORT_ITER_COMP_EXCH__genmod
          INTERFACE 
            SUBROUTINE TRANSPORT_ITER_COMP_EXCH(THIS,C1_OLD,C2NC_IG,    &
     &C_TILDE,CONC_NC,CONC_COMP,POROSITY,DELTA_T)
            ...
            END SUBROUTINE TRANSPORT_ITER_COMP_EXCH
          END INTERFACE 
        END MODULE TRANSPORT_ITER_COMP_EXCH__genmod

        !COMPILER-GENERATED INTERFACE MODULE: Thu Nov 14 16:39:29 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE TRANSPORT_ITER_COMP_EXCH_EE_AQ_CHEM__genmod
          INTERFACE 
            SUBROUTINE TRANSPORT_ITER_COMP_EXCH_EE_AQ_CHEM(THIS,C1_OLD, &
     &C2NC_IG,C_TILDE,CONC_NC,CONC_COMP,POROSITY,DELTA_T)
            ...
            END SUBROUTINE TRANSPORT_ITER_COMP_EXCH_EE_AQ_CHEM
          END INTERFACE 
        END MODULE TRANSPORT_ITER_COMP_EXCH_EE_AQ_CHEM__genmod

        !COMPILER-GENERATED INTERFACE MODULE: Sat Sep  7 11:39:04 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE READ_CHEMISTRY__genmod
          INTERFACE 
            SUBROUTINE READ_CHEMISTRY(THIS,PATH,UNIT_CHEM_SYST_FILE,    &
     &CHEM_SYST_FILE,UNIT_LOC_CHEM_FILE,LOC_CHEM_FILE,                  &
     &UNIT_TARGET_WATERS_INIT_FILE,TARGET_WATERS_INIT_FILE)

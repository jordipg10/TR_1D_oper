        !COMPILER-GENERATED INTERFACE MODULE: Wed Dec 11 20:14:21 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE SOLVE_REACTIVE_MIXING_IDEAL__genmod
          INTERFACE 
            SUBROUTINE SOLVE_REACTIVE_MIXING_IDEAL(THIS,ROOT,UNIT,      &
     ...
     &INT_METHOD_CHEM_REACTS)
            ...
            END SUBROUTINE SOLVE_REACTIVE_MIXING_IDEAL
          END INTERFACE 
        END MODULE SOLVE_REACTIVE_MIXING_IDEAL__genmod

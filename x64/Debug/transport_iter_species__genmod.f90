        !COMPILER-GENERATED INTERFACE MODULE: Tue Nov 19 12:02:58 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE TRANSPORT_ITER_SPECIES__genmod
          INTERFACE 
            SUBROUTINE TRANSPORT_ITER_SPECIES(THIS,C1_OLD,C2NC_IG,      &
     &C_TILDE,CONC_NC,CONC_COMP,POROSITY,DELTA_T)
            ...
            END SUBROUTINE TRANSPORT_ITER_SPECIES
          END INTERFACE 
        END MODULE TRANSPORT_ITER_SPECIES__genmod

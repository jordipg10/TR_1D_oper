        !COMPILER-GENERATED INTERFACE MODULE: Thu Nov 14 15:42:05 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE WATER_MIXING_ITER_EFI_EQ_KIN_ANAL__genmod
          INTERFACE 
            SUBROUTINE WATER_MIXING_ITER_EFI_EQ_KIN_ANAL(THIS,C1_OLD,   &
     &C2NC_IG,C_TILDE,CONC_NC,CONC_COMP,POROSITY,DELTA_T)
            ...
            END SUBROUTINE WATER_MIXING_ITER_EFI_EQ_KIN_ANAL
          END INTERFACE 
        END MODULE WATER_MIXING_ITER_EFI_EQ_KIN_ANAL__genmod

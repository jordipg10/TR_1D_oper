        !COMPILER-GENERATED INTERFACE MODULE: Mon Nov 25 16:10:30 2024
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE MASS_BALANCE_ERROR_ADE_TRANS_DIRICHLET_REVALENCE__genmod
          INTERFACE 
            FUNCTION MASS_BALANCE_ERROR_ADE_TRANS_DIRICHLET_REVALENCE(  &
     &THIS,CONC_OLD,CONC_NEW,DELTA_T,DELTA_X) RESULT(MASS_BAL_ERR)
            ...
            END FUNCTION                                                &
     &MASS_BALANCE_ERROR_ADE_TRANS_DIRICHLET_REVALENCE
          END INTERFACE 
        END MODULE                                                      &
     &MASS_BALANCE_ERROR_ADE_TRANS_DIRICHLET_REVALENCE__genmod
